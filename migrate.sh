...
DbContextNamespace="Cledev.OpenAI.Studio.Database"
...
dotnet ef migrations add $now_hourly"ChangeDb" --context $DbContextNamespace.ApplicationDbContext --output-dir data/migrations;
